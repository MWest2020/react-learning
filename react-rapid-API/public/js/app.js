...
var App = function (_React$Component2) {
    ...
    function App(props) {
        ...
        _this2.delete = function (e) {
            // delete entity - DELETE
            e.preventDefault();
            // deletes entities
            fetch('https://fairestdb.p.rapidapi.com/friend/friendModel/_id/' + _this2.state.id, {
                "method": "DELETE",
                "headers": {
                    "x-rapidapi-host": "fairestdb.p.rapidapi.com",
                    "x-rapidapi-key": "apikey"
        ...
        _this2.handleChange = function (changeObject) {
            _this2.setState(changeObject);
        };
        ...
        // bound with arrow functions instead
